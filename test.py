...
class ButtonStyle:
    """
    Telegram Bot API 9.4+ official style constants for KeyboardButton.
    These are passed to Telegram and render as colored buttons.
    """
    PRIMARY = "primary"
    SUCCESS = "success"
    DANGER = "danger"
...
def styled_button(text: str, callback_data: str = None, url: str = None, style: str = ButtonStyle.PRIMARY) -> InlineKeyboardButton:
    """ᴄʀᴇᴀᴛᴇ ᴀ ʙᴜᴛᴛᴏɴ ᴡɪᴛʜ ᴏꜰꜰɪᴄɪᴀʟ ᴛᴇʟᴇɢʀᴀᴍ ꜱᴛʏʟᴇ (ᴘʀɪᴍᴀʀʏ/ꜱᴜᴄᴄᴇꜱꜱ/ᴅᴀɴɢᴇʀ)"""
    if url:
